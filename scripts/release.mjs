...
const main = async () => {
	...
	await run(
		`gh release create ${tag} --title ${tag} --notes "Please refer to [CHANGELOG.md](https://github.com/futurethemes/astro-devtoolbar-tailwind/blob/main/package/CHANGELOG.md) for details."`,
	);
};
